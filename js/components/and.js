class And {
    ...
    updatePoints() {
        ...
        const pinOut = add(new Point(this.x, this.y), scale(rotate(this.directionVector, Math.PI / 2), 70));
    ...
    draw(ctx) {
        ...
        const center = add(new Point(this.x, this.y), scale(rotate(this.directionVector, Math.PI / 2), 25));
        ...
        ctx.fillText('AND', 0, 0); // Draw text at the translated origin
